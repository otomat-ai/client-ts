...
export type OGCGenerator<O extends GeneratorOption[]> = Omit<Generator, 'instructions' | 'data' | 'options' | 'history'> & {
    instructions: Omit<GeneratorInstructions, 'functions' | 'options'> & {
        functions: OGCGeneratorFunction[];
        options?: O;
    };
};
export declare function isOGCFunction(functionToCheck: OGCGeneratorFunction): functionToCheck is OGCFunction;
